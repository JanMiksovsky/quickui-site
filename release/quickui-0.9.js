...
(function() {
  var classPropertyNameMap, controlClassData, copyExcludingKeys, createElementReferenceFunction, cssClasses, elementInserted, elementInsertionInterval, evaluateControlJson, evaluateControlJsonProperties, evaluateControlJsonValue, findMethodImplementation, getCompoundPropertiesFromChildren, getPropertiesFromAttributes, inDocumentCallbacks, inDocumentListening, inDocumentListeningDeferred, initialize, isCompatible, isElementInDocument, isInputElement, makeCompatible, makeJQueryCompatible, makeQuickUICompatible, mutationEvents, propertyNameMaps, rehydrateElement, render, replaceElements, restorePropertyCase, significantContent, startInDocumentListening, stopInDocumentListening, symbolCounter, updateSavedSize,
    __slice = [].slice,
  ...
  jQuery.extend(Control, {
    ...
    */
    ...
    createAt: function(target, properties) {
      ...
      $controls.controlClass(this).addClass(cssClasses(this)).generic(String($controls.genericDefault) === "true").render().propertyVector("content", oldContents).properties(properties);
    ...
    */
    ...
    sub: function(options) {
      var newClass;
      newClass = jQuery.sub.call(this);
      if (options != null) {
        newClass.prototype.extend(options);
      }
      return newClass;
    }
  });
  ...
  */
  ...
  Control.coffee = function() {
    ...
    })(classFn.prototype.init, args, function(){});
  };
  ...
  */
  ...
  isCompatible = function(classFn) {
    return classFn.superclass === classFn.__super__.constructor;
  };
  ...
  */
  ...
  makeCompatible = function(classFn) {
    makeJQueryCompatible(classFn);
    return makeQuickUICompatible(classFn);
  };
  ...
  */
  ...
  makeJQueryCompatible = function(classFn) {
    var rootjQuerySub, superclass;
    classFn.superclass = superclass = classFn.__super__.constructor;
    if (superclass.__super__ && !isCompatible(superclass)) {
    ...
    classFn.prototype.init = function(selector, context) {
      ...
      return jQuery.prototype.init.call(this, selector, context, rootjQuerySub);
    };
    classFn.fn = classFn.prototype;
    classFn.prototype.init.prototype = classFn.prototype;
    return rootjQuerySub = classFn(document);
  };
  ...
  */
  ...
  makeQuickUICompatible = function(classFn) {
    var className, _ref;
    return className = classFn.prototype.className = (_ref = classFn.name) != null ? _ref : /function\s+( [^\( ]* )/.exec(classFn.toString())[1];
  };
    ...
    */
    ...
    chain: function() {
      ...
      return function(value) {
        var fn, functionName, i, length, params, result, _j, _len1;
        result = this;
