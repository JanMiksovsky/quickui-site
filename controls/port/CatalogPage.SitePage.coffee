...
class window.CatalogPage extends SitePage
  inherited:
    ...
    , " ",
      html: "<div class=\"section\" />"
      ref: "sectionBaseClasses"
      
      # <ControlClassHierarchy ref="controlClassHierarchy"/> 
      content: [" ", "<h2>Class relationships</h2>", " ", " ", "<p>\n                    This shows the control's base classes (in black),\n                    other classes used by the control, and any subclasses.\n                </p>", " ",
        control: "ControlClassGraph"
        ref: "controlClassGraph"
      , " "]
    , " ",
      html: "<div class=\"section\" />"
      ref: "sectionMembers"
      content: [" ", "<h2>Class members</h2>", " ",
        control: "ControlMemberTable"
        ref: "controlMemberTable"
      , " "]
    , " ",
      html: "<div class=\"section\" />"
      ref: "sectionContent"
  ...
  _loadDemo: (className) ->
    ...
    if demoSource and demoSource.length > 0
